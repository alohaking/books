<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('booksApp.category.home.title')" id="category-heading">Categories</span>
            <router-link :to="{name: 'CategoryCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-category">
                ...
                <span  v-text="$t('booksApp.category.home.createLabel')">
                    Create new Category
                </span>
            </router-link>
        </h2>
        ...
        <div class="table-responsive" v-if="categories">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('booksApp.category.name')">Name</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="booksApp.category.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-category-heading" v-bind:title="$t('booksApp.category.delete.question')">Are you sure you want to delete this Category?</p>
            </div>
