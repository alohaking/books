<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('booksApp.author.home.title')" id="author-heading">Authors</span>
            <router-link :to="{name: 'AuthorCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-author">
                ...
                <span  v-text="$t('booksApp.author.home.createLabel')">
                    Create new Author
                </span>
            </router-link>
        </h2>
        ...
        <br/>
        <div class="table-responsive" v-if="authors">
            <table class="table table-striped">
                <thead>
                <tr>
                    <th><span v-text="$t('global.field.id')">ID</span></th>
                    <th><span v-text="$t('booksApp.author.name')">Name</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="booksApp.author.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-author-heading" v-bind:title="$t('booksApp.author.delete.question')">Are you sure you want to delete this Author?</p>
            </div>
