...
import static org.kevin.book.web.rest.TestUtil.createFormattingConversionService;
...
public class BookResourceIT {
    ...
    private static final LocalDate DEFAULT_SHOW_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_SHOW_TIME = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getShowTime()).isEqualTo(DEFAULT_SHOW_TIME);
    }
    ...
    public void updateBook() throws Exception {
        ...
        assertThat(testBook.getShowTime()).isEqualTo(UPDATED_SHOW_TIME);
    }
